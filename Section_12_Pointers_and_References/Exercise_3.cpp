...
Write a C++ function reverse_array that takes an integer array and its size as input and 
reverses the order of the elements in the array. The function should modify the array in-place.
...
Output:
The function should modify the array in-place, reversing the order of the elements. 
You should NOT make a copy of the original array.
...
int main()
{
    ...
    reverse_array(arr, size);
    cout << "Reverse array: " << arr[0] << " " << arr[1] << " " << arr[2] << " " << arr[3] << " " << arr[4] << endl;
